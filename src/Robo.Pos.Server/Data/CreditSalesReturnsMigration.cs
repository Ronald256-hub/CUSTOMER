...
public static class CreditSalesReturnsMigration
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Assembly assembly = typeof(CreditSalesReturnsMigration).Assembly;
        ...
        await using Stream stream =
            ...
            ?? throw new InvalidOperationException(
                "The credit-sales return migration resource was not found.");
